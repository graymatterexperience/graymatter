  ...
  no_commands do
    ...
    def well_known_path_for(file)
      if OS.windows?
        ...
        File.join(ENV['HOME'], 'projects/2018/graymatter', file)
      end
    end
    ...
    def user_credentials_for(scope)
      ...
      ENV['GOOGLE_CLIENT_ID'] = '372464072161-75rvmh9u1c65uuun02u0hvpa9rcb5n54.apps.googleusercontent.com'
      ENV['GOOGLE_CLIENT_SECRET'] = 'meraOceQiCeIN7jsSMGIJYq6'

      if ENV['GOOGLE_CLIENT_ID']
        client_id = Google::Auth::ClientId.new(ENV['GOOGLE_CLIENT_ID'], ENV['GOOGLE_CLIENT_SECRET'])
      else
        # try this too to see if this works the same as the first condition
